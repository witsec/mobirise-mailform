		...
		"witsec-mailform/components",
		{
			"witsec-mailform-m3": {
				...
				_params: {
					...
					showUpload:      { type: "switch",   title: "Show Upload",                 default: false },
					...
					mtxt:            { type: "textarea", title: "Mail Mini-Template",          default: "", value: ""},
					rtxt:            { type: "textarea", title: "Response Mini-Template (if applicable)", default: "", value: ""},
